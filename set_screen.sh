...
MODE=TB
OUT_PORT=HDMI-1
[ "$(xrandr | grep '2560x1440')" ] && MODE=H$MODE
...
__get_inner_view() {
	...
	TB) echo "--output $INNER_PORT --mode 2560x1600 --pos 0x1440 --rotate normal" ;;
...
__get_outer_view() {
	outport=$1
	case "$MODE" in
	LR) echo "--output $OUT_PORT --mode 1920x1080 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
	TB) echo "--output $OUT_PORT --primary --mode 2560x1440 --pos 0x0 " ;;
	HLR) echo "--output $OUT_PORT --mode 2560x1080 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
	HTB) echo "--output $OUT_PORT --mode 2560x1080 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
	esac
}
