...
##### TOGGLE_SERVER_MENU #####
    ...
    toggle_server_menu_cmds[1]='coproc (sudo docker restart v2raya; sleep 1; $DWM/statusbar/statusbar.sh update icons)'
    ...
    [ "$(sudo docker ps | grep v2raya)" ] && toggle_server_menu_cmds[1]='coproc (sudo docker stop v2raya; sleep 1; $DWM/statusbar/statusbar.sh update icons)'
